...
// =====================================================================
// relax command: set up Dynamic Relaxation for initial stress equilibrium
// =====================================================================
...
int runRelax(const std::string& yamlFile, ConsoleOutput& console) {
    ...
    std::string mode = "explicit";
    int level = 2;
    double drterm = 0.0;       // DR phase max time (0 = infinity/convergence only)
    double endtimeYaml = -1.0; // post-DR analysis endtime (-1 = keep existing)
    ...
    // Remove DATABASE_BINARY_D3DRLF (re-insert if d3drlf=true)
    removeAndLog("*DATABASE_BINARY_D3DRLF");
    ...
    impl_insertBeforeEnd(lines, drCards);

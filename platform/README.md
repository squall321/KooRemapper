...
- ✅ Phase 4 — op 카탈로그 **47개** (JSON Schema 인자, 예제, 매뉴얼) (`/api/v1/operations`, `/operations/{op}`)
...
- ✅ Phase 7 — MCP 서버 (`mcp_server/server.py`, FastMCP streamable-http, 51개 도구, PAT 전달) — Claude 전체 사이클 e2e 통과
...
- ✅ Phase 10 — 하드닝·사용자관리·웹/MCP 패리티 UX: 회원가입/비번변경/관리자 사용자관리, rate limiting(429),
  ...
  MCP 도구 51개(whoami/system_status/system_capabilities/list_session_jobs 포함, auth·토큰·admin은 보안상 웹 전용). 계획: `../KOOREMAPPER_PHASE10_PLAN.md`
